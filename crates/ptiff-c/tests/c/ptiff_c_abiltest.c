...
static void test_version(void) {
    ...
    /* The workspace intends 1.1.0 as the release version. */
    CHECK(ct.major == 1, "compile-time major == 1");
    CHECK(ct.minor == 1, "compile-time minor == 1");
    ...
    CHECK(m == 1 && n == 1 && p == 0, "runtime_version_out == 1.1.0");
    ptiff_compile_time_version_out(&m, &n, &p);
    CHECK(m == 1 && n == 1 && p == 0, "compile_time_version_out == 1.1.0");
