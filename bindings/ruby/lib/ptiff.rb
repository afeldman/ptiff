...
#
# * `Ptiff` -- the raw, SWIG-generated low-level surface (`lib/ptiff.bundle`):
#   all the `ptiff_*` C-ABI functions and the `Ptiff_*`/`PTIFF_*` structs and
#   constants. This is what the compiler produces and what the wrapper classes
#   underneath build on.
