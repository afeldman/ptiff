...
Gem::Specification.new do |spec|
  ...
  spec.description = <<~DESC
    Ruby bindings for PTIFF (planetary imaging) over the Rust-based `libptiff_c`
    C ABI: raw SWIG output (bindings/swig/ptiff.i). `lib/ptiff.bundle` is a
    compiled native extension linked against `libptiff_c` -- regenerate it with
    `make -C ../swig ruby` before
